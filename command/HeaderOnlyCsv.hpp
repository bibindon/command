...
public:
    ...
    static std::vector<std::vector<std::wstring> > Read_Deprecated(const std::wstring& filepath)
    {
        std::vector<std::vector<std::wstring> > csvData;
    ...
    static void Write_deprecated(const std::wstring& filepath, const std::vector<std::vector<std::wstring> >& csvData)
    {
